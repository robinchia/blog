...
[![]( "NoSQL")](http://cdn2.jobbole.com/2013/07/NoSQL.png "NoSQL")

[![]( "NoSQL2")](http://cdn2.jobbole.com/2013/07/NoSQL2.png "NoSQL2")
...
[![]( "NoSQL3")](http://cdn2.jobbole.com/2013/07/NoSQL3.png "NoSQL3")
...
[![]( "NoSQL4")](http://cdn2.jobbole.com/2013/07/NoSQL4.png "NoSQL4")
...
[![]( "NoSQL5")](http://cdn2.jobbole.com/2013/07/NoSQL5.png "NoSQL5")
...
[![]( "NoSQL6")](http://cdn2.jobbole.com/2013/07/NoSQL6.png "NoSQL6")
...
[![]( "NoSQL7")](http://cdn2.jobbole.com/2013/07/NoSQL7.png "NoSQL7")
...
[![]( "NoSQL8")](http://cdn2.jobbole.com/2013/07/NoSQL8.png "NoSQL8")
...
?[![]( "NoSQL9")](http://cdn2.jobbole.com/2013/07/NoSQL9.png "NoSQL9")
...
[![]( "NoSQL10")](http://cdn2.jobbole.com/2013/07/NoSQL10.png "NoSQL10")
...
[![]( "NoSQL11")](http://cdn2.jobbole.com/2013/07/NoSQL11.png "NoSQL11")
...
[![]( "NoSQL12")](http://cdn2.jobbole.com/2013/07/NoSQL12.png "NoSQL12")
...
[![]( "NoSQL13")](http://cdn2.jobbole.com/2013/07/NoSQL13.png "NoSQL13")
...
[![]( "NoSQL14")](http://cdn2.jobbole.com/2013/07/NoSQL14.png "NoSQL14")
### 协调者竞选
...
1. 假设节点5挂了，并且节点2和节点3同时发现了这一情况。两个节点开始竞选并发送竞选消息给ID更大的节点。
1. 节点4淘汰了节点2和3，节点3淘汰了节点2。
1. 这时候节点1察觉了节点5失效并向所有ID更大的节点发送了竞选信息。
1. 节点2、3和4都淘汰了节点1。
1. 节点4发送竞选信息给节点5。
1. 节点5没有响应，所以节点4宣布自己当选并向其他节点通告了这一消息。

[![]( "NoSQL15")](http://cdn2.jobbole.com/2013/07/NoSQL15.png "NoSQL15")
...
1. [I. Stoica et al. Chord: A Scalable Peer-to-peer Lookup Service for Internet Applications](http://pdos.csail.mit.edu/papers/chord:sigcomm01/chord_sigcomm.pdf)
1. [R. J. Honicky, E.L.Miller. Replication Under Scalable Hashing: A Family of Algorithms for Scalable Decentralized Data Distribution](http://www.ssrc.ucsc.edu/Papers/honicky-ipdps04.pdf)
1. [G. Shah. Distributed Data Structures for Peer-to-Peer Systems](http://cs-www.cs.yale.edu/homes/shah/pubs/thesis.pdf)
1. [A. Montresor, Gossip Protocols for Large-Scale Distributed Systems](http://sbrc2010.inf.ufrgs.br/resources/presentations/tutorial/tutorial-montresor.pdf)
1. [R. Escriva, B. Wong, E.G. Sirer. HyperDex: A Distributed, Searchable Key-Value Store](http://hyperdex.org/papers/hyperdex.pdf)
1. [A. Demers et al. Epidemic Algorithms for Replicated Database Maintenance](http://net.pku.edu.cn/~course/cs501/2009/reading/1987-SPDC-Epidemic algorithms for replicated database maintenance.pdf)
1. [G. DeCandia, et al. Dynamo: Amazon’s Highly Available Key-value Store](http://www.read.seas.harvard.edu/~kohler/class/cs239-w08/decandia07dynamo.pdf)
1. [R. van Resesse et al. Efficient Reconciliation and Flow Control for Anti-Entropy Protocols](http://www.cs.cornell.edu/home/rvr/papers/flowgossip.pdf)
1. [S. Ranganathan et al. Gossip-Style Failure Detection and Distributed Consensus for Scalable Heterogeneous Clusters](http://www.hcs.ufl.edu/pubs/CC2000.pdf)
1. [http://www.slideshare.net/kakugawa/distributed-counters-in-cassandra-cassandra-summit-2010](http://www.slideshare.net/kakugawa/distributed-counters-in-cassandra-cassandra-summit-2010)
1. [N. Hayashibara, X. Defago, R. Yared, T. Katayama. The Phi Accrual Failure Detector](http://cassandra-shawn.googlecode.com/files/The Phi Accrual Failure Detector.pdf)
1. [M.J. Fischer, N.A. Lynch, and M.S. Paterson. Impossibility of Distributed Consensus with One Faulty Process](http://www.cs.mcgill.ca/~carl/impossible.pdf)
1. [N. Hayashibara, A. Cherif, T. Katayama. Failure Detectors for Large-Scale Distributed Systems](http://ddg.jaist.ac.jp/pub/HCK02.pdf)
1. M. Leslie, J. Davies, and T. Huffman. A Comparison Of Replication Strategies for Reliable Decentralised Storage
1. [A. Lakshman, P.Malik. Cassandra – A Decentralized Structured Storage System](http://www.cs.cornell.edu/projects/ladis2009/papers/lakshman-ladis2009.pdf)
1. N. A. Lynch. Distributed Algorithms
1. G. Tel. Introduction to Distributed Algorithms
1. [http://basho.com/blog/technical/2010/04/05/why-vector-clocks-are-hard/](http://basho.com/blog/technical/2010/04/05/why-vector-clocks-are-hard/)
1. [L. Lamport. Paxos Made Simple](http://research.microsoft.com/en-us/um/people/lamport/pubs/paxos-simple.pdf)
1. [J. Chase. Distributed Systems, Failures, and Consensus](http://www.cs.duke.edu/courses/fall07/cps212/consensus.pdf)
1. [W. Vogels. Eventualy Consistent – Revisited](http://www.allthingsdistributed.com/2008/12/eventually_consistent.html)
1. [J. C. Corbett et al. Spanner: Google’s Globally-Distributed Database](http://static.googleusercontent.com/external_content/untrusted_dlcp/research.google.com/en/archive/spanner-osdi2012.pdf)
