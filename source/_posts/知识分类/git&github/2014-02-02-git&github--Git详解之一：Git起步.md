...
本章介绍开始使用 Git 前的相关知识。我们会先了解一些版本控制工具的历史背景，然后试着让 Git 在你的系统上跑起来，直到最后配置好，可以正常开始开发工作。读完本章，你就会明白为什么 Git 会如此流行，为什么你应该立即开始使用它。（[查看Git详解系列的全部文章](http://blog.jobbole.com/tag/git/)）
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start1.png "Git详解之一：Git起步")
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start2.png "Git详解之一：Git起步")
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start3.png "Git详解之一：Git起步")
图 1-3. 分布式版本控制系统
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start4.png "Git详解之一：Git起步")
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start5.png "Git详解之一：Git起步")
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start6.png "Git详解之一：Git起步")
...
[![Git详解之一：Git起步]( "Git详解之一：Git起步")](http://cdn2.jobbole.com/2012/08/Git-start7.png "Git详解之一：Git起步")
图 1-7. Git OS X 安装工具
...
这种方式就不需要再自己安装依赖库了，Macports 会帮你[搞定](http://www.amazon.cn/gp/product/B007XPTAIS/ref=as_li_qf_sp_asin_il_tl?ie=UTF8&tag=vastwork-23&linkCode=as2&camp=536&creative=3200&creativeASIN=B007XPTAIS "搞定(套装共3册) ")这些麻烦事。一般上面列出的安装选项已经够用，要是你想用 Git 连接 Subversion 的代码仓库，还可以加上 +svn 选项，具体将在第八章作介绍。（译注：还有一种是使用 homebrew（
...
 
![6 votes, average: 5.00 out of 5]( "6 votes, average: 5.00 out of 5")![6 votes, average: 5.00 out of 5]( "6 votes, average: 5.00 out of 5")![6 votes, average: 5.00 out of 5]( "6 votes, average: 5.00 out of 5")![6 votes, average: 5.00 out of 5]( "6 votes, average: 5.00 out of 5")![6 votes, average: 5.00 out of 5]( "6 votes, average: 5.00 out of 5") (***6** 个评分，平均: **5.00***)
