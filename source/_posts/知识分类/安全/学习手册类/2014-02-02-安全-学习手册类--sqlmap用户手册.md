...
[首页](http://drops.wooyun.org/ "首页") » [技术分享](http://drops.wooyun.org/category/tips "查看 技术分享 中的全部文章") » sqlmap用户手册

## [sqlmap用户手册 ![]()](http://drops.wooyun.org/tips/143 "Permanent Link to sqlmap用户手册")

22人收藏 [收藏]()

2013/06/13 18:45  | [瞌睡龙](http://drops.wooyun.org/author/瞌睡龙 "由 瞌睡龙 发布")  | [技术分享](http://drops.wooyun.org/category/tips "查看 技术分享 中的全部文章")  | [占个座先]()
...
分享到： []( "分享到QQ空间") []( "分享到新浪微博") []( "分享到腾讯微博") []( "分享到人人网") []( "分享到网易微博") [4]( "累计分享4次")
### 相关日志

* [sqlmap用户手册[续]](http://drops.wooyun.org/tips/401)
* [Hacking Oracle with Sql Injection](http://drops.wooyun.org/tips/57)
* [python脚本处理伪静态注入](http://drops.wooyun.org/tips/125)
* [PostgreSQL的那点事儿](http://drops.wooyun.org/tips/218)
* [Dionaea低交互式蜜罐部署详解](http://drops.wooyun.org/tips/640)
* [得到内网域管理员的5种常见方法](http://drops.wooyun.org/tips/646)
上一篇:[Browser Security-基本概念](http://drops.wooyun.org/papers/146)

下一篇:[常见验证码的弱点与验证码识别](http://drops.wooyun.org/tips/141)

### 楼被抢了 21 层了... [抢座]()、[Rss 2.0](http://drops.wooyun.org/tips/143/feed)或者 [Trackback](http://drops.wooyun.org/tips/143/trackback)

* ![]() se55i0n | 2013/06/13 19:01 | [#]()
...
[登录以回复](http://drops.wooyun.org/login)
* ![]() Demon | 2013/06/13 22:40 | [#]()

地板

[登录以回复](http://drops.wooyun.org/login)
* ![]() 墨水心_Len | 2013/06/14 09:41 | [#]()

mark

[登录以回复](http://drops.wooyun.org/login)
* ![]() zzR | 2013/06/14 10:13 | [#]()
...
[登录以回复](http://drops.wooyun.org/login)
* ![]() Alcar | 2013/06/14 21:15 | [#]()

很详细，赞

[登录以回复](http://drops.wooyun.org/login)
* ![]() HuGtion | 2013/06/14 23:11 | [#]()
...
回头看穿山甲，简直是弱爆了！以后就用他了

[登录以回复](http://drops.wooyun.org/login)
* ![]() 小 葛 | 2013/06/16 01:00 | [#]()

可不可以不要这么详细

[登录以回复](http://drops.wooyun.org/login)
* ![]() Deep | 2013/06/16 07:56 | [#]()

mark

[登录以回复](http://drops.wooyun.org/login)
* ![]() yofx | 2013/06/17 14:05 | [#]()

非常好：） mark

[登录以回复](http://drops.wooyun.org/login)
* ![]() lxsec | 2013/06/17 15:27 | [#]()

真是好东西~mark

[登录以回复](http://drops.wooyun.org/login)
* ![]() lion(lp) | 2013/06/18 12:19 | [#]()

辛苦了～～打了这么多

[登录以回复](http://drops.wooyun.org/login)
* ![]() hack2012 | 2013/06/18 14:45 | [#]()

写的真详细。

[登录以回复](http://drops.wooyun.org/login)
* ![]() txcbg | 2013/06/28 20:57 | [#]()

很详细啊，赞一个。

[登录以回复](http://drops.wooyun.org/login)
* ![]() gniq | 2013/07/12 17:18 | [#]()

比我原来总结的更详细一些，赞一个

[登录以回复](http://drops.wooyun.org/login)
* ![]() 基佬库克 | 2013/07/12 19:43 | [#]()

–flush-session #刷新当前目标的会话文件
–fresh-queries #忽略在会话文件中存储的查询结果
这两个开关没有讲到,这两个对中断后重新注入有帮助

[登录以回复](http://drops.wooyun.org/login)
* ![]() 么么哒 | 2013/07/28 17:17 | [#]()

@瞌睡龙 大侠 win下sqlmap射出来的数据无法正常显示，如何解？

[登录以回复](http://drops.wooyun.org/login)

* ![]() 瞌睡龙 | 2013/07/29 11:46 | [#]()

可能是编码不对，使用--charset参数试试，例如：--charset=GBK 可自定义为返回的编码为GBK。

[登录以回复](http://drops.wooyun.org/login)
* ![]() hijack | 2013/08/24 10:10 | [#]()
