...
2013/06/19 18:55  | [瞌睡龙](http://drops.wooyun.org/author/瞌睡龙 "由 瞌睡龙 发布")  | [技术分享](http://drops.wooyun.org/category/tips "查看 技术分享 中的全部文章")  | [占个座先]()

### 层叠样式表（css）

调用方式有三种：
1 用<style> 2 通过<link rel=stylesheet>，或者使用style参数。 3 XML（包括XHTML）可以通过<?xml-stylesheet href=...?>
...
下面两个代码IE下相同
<A STYLE='color: expression\028 alert \028 1 \029 \029'> <A STYLE='color: expression(alert(1))'>
...
代码一 代码二 &#x3cscript> var my_variable1 = 1; var my_variable2 = &#x3c/script> &#x3cscript> 2; &#x3c/script> &#x3cscript> var my_variable1 = 1; var my_variable2 = 2; &#x3c/script>
...
下一篇:[Browser Security-超文本标记语言（HTML）](http://drops.wooyun.org/tips/147)
